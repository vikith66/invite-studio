        ...
        <GlassCard className="p-8">
          ...
          <form className="space-y-6">
            ...
            <div className="flex items-start gap-2">
              <input
                type="checkbox"
                className="w-4 h-4 mt-1 rounded border-gray-300 text-[#C7B8EA] focus:ring-[#C7B8EA] cursor-pointer"
              />
              <span className="text-sm text-gray-600">
                I agree to the{' '}
                <Link to="/terms" className="text-[#C7B8EA] hover:text-[#B8A8DA] transition-colors font-medium">
                  Terms of Service
                </Link>{' '}
                and{' '}
                <Link to="/privacy" className="text-[#C7B8EA] hover:text-[#B8A8DA] transition-colors font-medium">
                  Privacy Policy
                </Link>
              </span>
            </div>
          ...
          <div className="mt-8 space-y-4">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white/70 text-gray-500">Or sign up with</span>
              </div>
            </div>
          ...
          <div className="mt-6 text-center text-sm text-gray-600">
            ...
            <Link to="/login" className="text-[#C7B8EA] hover:text-[#B8A8DA] transition-colors font-medium">
              Login
            </Link>
          </div>
        </GlassCard>
